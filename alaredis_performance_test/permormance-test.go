...
var bodyParser = alaredis_lib.BodyParserJson{}
...
func generateCases(client *alaredis_lib.CacheClient,limit int, letters *string, keyLen int, errRate float32, filePath string) {
...
func testCases(c *alaredis_lib.CacheClient, filePath string,limit int, concurrence int) {
